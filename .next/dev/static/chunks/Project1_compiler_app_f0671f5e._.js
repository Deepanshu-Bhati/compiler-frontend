...
_s(TerminalArea, "uNQYW7xpVCpUkoo809omlBOeRhA=", false, function() {
    return [
...
function Code() {
    ...
    const compile = async ()=>{
        console.log(lang);
        let res = await __TURBOPACK__imported__module__$5b$project$5d2f$Project1$2f$compiler$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("http://localhost:8080/compile", {
            language: lang,
            code: code
        });
