...
function Provider({ children }) {
    ...
    const messageHandlerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const closeHandlerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null); // << added ref
...
_s(Provider, "+nQqfAWSwNi/FTxcmkW+ErHwbbE=");
_c = Provider;
var _c;
...
"[project]/app/Components/hooks.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useTheme() {
    _s();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ThemeContext"]);
}
_s(useTheme, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
function useHook() {
    _s1();
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WebSocketContext"]);
    if (!ctx) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Components$2f$hooks$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/Components/hooks.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Navbar() {
    _s();
    const { theme, setTheme } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Components$2f$hooks$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"])();
    const toggleTheme = ()=>{
...
_s(Navbar, "5ABGV54qnXKp6rHn7MS/8MjwRhQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Components$2f$hooks$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"]
    ];
});
_c = Navbar;
var _c;
...
function TerminalArea() {
    ...
    const { setOnMessage, setOnClose, send } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Components$2f$hooks$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHook"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TerminalArea.useEffect": ()=>{
            let disposed = false;
            const initTerminal = {
                "TerminalArea.useEffect.initTerminal": async ()=>{
                    if (!containerRef.current) return;
                    // ✅ dynamic imports (prevents `self is not defined`)
                    const { Terminal } = await __turbopack_context__.A("[project]/node_modules/xterm/lib/xterm.js [app-client] (ecmascript, async loader)");
                    const { FitAddon } = await __turbopack_context__.A("[project]/node_modules/xterm-addon-fit/lib/xterm-addon-fit.js [app-client] (ecmascript, async loader)");
                    if (disposed) return;
            ...
            }["TerminalArea.useEffect.initTerminal"];
            /** ---------- SELF: OUTPUT HANDLER ---------- */ const selfHandleOutput = {
                "TerminalArea.useEffect.selfHandleOutput": (terminal)=>{
                    const queue = [];
                    let running = false;
                    const flush = {
                        "TerminalArea.useEffect.selfHandleOutput.flush": async ()=>{
                            if (running) return;
                            running = true;
                            while(queue.length > 0){
                                terminal.write(queue.shift());
                                await new Promise({
                                    "TerminalArea.useEffect.selfHandleOutput.flush": (r)=>setTimeout(r, 1)
                                }["TerminalArea.useEffect.selfHandleOutput.flush"]);
                            }
                            running = false;
                        }
                    }["TerminalArea.useEffect.selfHandleOutput.flush"];
                    setOnMessage({
                        "TerminalArea.useEffect.selfHandleOutput": (data)=>{
                            queue.push(data);
                            flush();
                        }
                    }["TerminalArea.useEffect.selfHandleOutput"]);
                    setOnClose({
                        "TerminalArea.useEffect.selfHandleOutput": ()=>{
            ...
            /** ---------- SELF: INPUT HANDLER ---------- */ const selfHandleInput = {
                "TerminalArea.useEffect.selfHandleInput": (terminal)=>{
                    let buffer = "";
                    terminal.onData({
                        "TerminalArea.useEffect.selfHandleInput": (data)=>{
                            // ENTER
                            if (data === "\r") {
                    ...
                    }["TerminalArea.useEffect.selfHandleInput"]);
                }
            }["TerminalArea.useEffect.selfHandleInput"];
            /** ---------- SELF: SEND LOGIC ---------- */ const selfSend = {
                "TerminalArea.useEffect.selfSend": (input, terminal)=>{
                    if (!input) return;
                    if (input === "clear") {
                        terminal.clear();
                        return;
            ...
            }["TerminalArea.useEffect.selfSend"];
            initTerminal();
            return ({
                "TerminalArea.useEffect": ()=>{
                    disposed = true;
...
_s(TerminalArea, "tVCXbCRNeJthFbTZnvfnZzxu0Ig=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Components$2f$hooks$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHook"]
    ];
});
_c = TerminalArea;
var _c;
__turbopack_context__.k.register(_c, "TerminalArea");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/Components/Code.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Code() {
    _s();
    const { theme } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Components$2f$hooks$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"])();
    const [lang, setLang] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("java");
    ...
    const { connect, socketRef } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$Components$2f$hooks$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHook"])();
    ...
    const compile = async ()=>{
        const base = ("TURBOPACK compile-time value", "https://devos.live/");
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        let res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${base}compile`, {
            language: lang,
            code: code
        }, {
            headers: {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            ...
                                            fileName: "[project]/app/Components/Code.tsx",
                                            lineNumber: 84,
                                            columnNumber: 15
                                        }, this),
                                        Languages.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                value: item,
                                                children: item
                                            }, item, false, {
                                                fileName: "[project]/app/Components/Code.tsx",
...
//# sourceMappingURL=app_15cba699._.js.map